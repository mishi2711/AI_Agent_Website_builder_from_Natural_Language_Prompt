        ...
        <div className="auth-page-wrapper flex-grow flex items-center justify-center relative px-4 py-24 md:py-32 w-full min-h-[calc(100vh-280px)]">
            ...
            <div className="w-full max-w-md z-10 transition-colors duration-500">
                ...
                <div className="glass-card rounded-xl p-8 shadow-2xl relative overflow-hidden transition-all duration-500">
                    <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); alert("Signup intent captured!"); }}>
                        {/* Name Field */}
                        ...
                        {/* CTA Button */}
                        <button className="w-full jewel-button text-white font-headline font-bold py-4 rounded-lg mt-4 transition-all duration-300 active:scale-95" type="submit">
                            Create Account
                        </button>
                    </form>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button type="button" onClick={() => alert("Google OAuth")} className="flex items-center justify-center space-x-2 py-3 px-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 group">
                        ...
                        <button type="button" onClick={() => alert("GitHub OAuth")} className="flex items-center justify-center space-x-2 py-3 px-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 group">
