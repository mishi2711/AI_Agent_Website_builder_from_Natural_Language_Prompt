            ...
            <div className="w-full max-w-md z-10 transition-colors duration-500">
                ...
                <div className="glass-card rounded-xl p-8 shadow-2xl relative overflow-hidden">
                    <form className="space-y-6" onSubmit={(e) => { 
                        ...
                        {/* CTA Button */}
                        <button className="w-full jewel-button text-white font-headline font-bold py-4 rounded-lg mt-4 flex items-center justify-center gap-2 transition-all duration-300 active:scale-95" type="submit">
                            <span>Log In</span>
